        ...
        <div className="w-full md:w-[42%] bg-primary text-white p-8 lg:p-12 flex flex-col justify-between relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="space-y-6">
              {[
                { icon: <Phone className="w-5 h-5" />, label: 'Office Number', value: '+250-798-400-111 / +250-788-307-498' },
                { icon: <Mail className="w-5 h-5" />, label: 'Customer Support', value: 'info@efiche.africa' },
                { icon: <MapPin className="w-5 h-5" />, label: 'Our Office', value: 'Kigali, Rwanda' },
                { icon: <Clock className="w-5 h-5" />, label: 'Business Hours', value: '9 AM - 5 PM, Monday - Friday' },
                ...
                <div key={label} className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-sm lg:text-base text-white">{label}</h4>
                    <p className="text-white/70 text-xs lg:text-sm mt-0.5">{value}</p>
                  </div>
                </div>
              ))}
            </div>
        ...
        <div className="w-full md:w-[58%] p-8 lg:p-14 bg-white flex flex-col justify-center">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                >
                  ...
                  <option value="demo" className="text-slate-800">Request a Demo</option>
                </select>
            ...
            <div className="pt-2">
              ...
              >
                <span className="tracking-wide text-sm font-medium px-1">Send A Message</span>
